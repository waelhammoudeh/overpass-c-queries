...
void printHelp(FILE *toStream){
	...
	"                     GPS coordinates. Please avoid \"wkt\" and \"csv\" extensions here.\n\n"
	...
	"                  in \"filename\".\n"
	"                 This option produces three WKT files using \"filename\" as follows:\n"
	"                1) filename: has Well Known Text for found nodes for each cross roads.\n"
    "                 If no extension was given in filename, program adds \".wkt\" to filename.\n"
	"                Note that using \".csv\" file extension makes it easier for QGIS\n"
	"                  to find your file.\n\n"
	"                2) filename only without extension with added \"_Bbox.wkt\" for Bounding\n"
	"                  box polygon found in input file(s).\n"
	"                3) filename only with \"_MidGps.wkt\" added for Well Known Text point for\n"
	"                 each cross roads only if nodes were found for that cross roads.\n"
	"                Please do not use \"wkt\" or \"csv\" with output file name [-o --output]\n"
